...
# Some modifications were made by Casey Smith (2023). In the program below, the
# values for bg and disabledbg are changed. Furthermore, the foreground color for
# AccentButton is changed to white, and the Horizontal TickScale always displays
# tick-hor-accent.gif. Selected GIFs in the light directory were changed to 
...
namespace eval ttk::theme::azure-light {
    ...
    ttk::style theme create azure-light -parent clam -settings {
        ...
        # AccentButton
        ttk::style configure Accent.TButton -padding {8 4 8 4} -width -10 -anchor center -foreground "#ffffff"
        ...
        ttk::style element create Horizontal.TickScale.slider \
            image [list $I(tick-hor-accent) \
                disabled $I(tick-hor-accent) \
                pressed $I(tick-hor-accent) \
                active $I(tick-hor-accent) \
            ] -sticky {}
